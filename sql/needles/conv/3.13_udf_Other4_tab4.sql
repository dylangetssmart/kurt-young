...
-- Dynamically get all columns from TestClientNeedles..user_tab4_data for unpivoting
...
select * from TestClientNeedles..user_tab4_data
...
FROM [sma_MST_CaseType] CST
	...
	JOIN [TestClientNeedles].[dbo].[user_tab4_matter] M
