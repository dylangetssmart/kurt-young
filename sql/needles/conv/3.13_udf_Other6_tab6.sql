...
-- Dynamically get all columns from TestClientNeedles..user_tab6_data for unpivoting
...
FROM ( 
    ...
    FROM TestClientNeedles..user_tab6_data ud
...
select * from TestClientNeedles..user_tab6_data
...
FROM [sma_MST_CaseType] CST
	...
	JOIN [TestClientNeedles].[dbo].[user_tab6_matter] M
