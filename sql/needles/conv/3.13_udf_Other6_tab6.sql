...
-- Dynamically get all columns from NeedlesSLF..user_tab6_data for unpivoting
...
FROM ( 
    ...
    FROM NeedlesSLF..user_tab6_data ud
...
select * from NeedlesSLF..user_tab6_data
...
FROM [sma_MST_CaseType] CST
	...
	JOIN [NeedlesSLF].[dbo].[user_tab6_matter] M
