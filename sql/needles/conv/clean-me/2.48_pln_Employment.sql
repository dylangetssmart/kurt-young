...
FROM TestNeedles..user_party_data ud
	...
	inner join TestNeedles..Employer_Address_Helper help
	...
	-- -- Indv
	-- left join TestNeedles.dbo.IndvOrgContacts_Indexed ioci
	-- 	on n.names_id = ioci.saga
	-- 	and ioci.CTG = 1

	-- -- Org
	-- left join TestNeedles.dbo.IndvOrgContacts_Indexed ioco
...
from TestNeedles..value_indexed v
JOIN sma_trn_Cases cas
