...
-- Dynamically get all columns from TestClientNeedles..user_tab3_data for unpivoting
...
FROM ( 
    ...
    FROM TestClientNeedles..user_tab3_data ud
...
select * from TestClientNeedles..user_tab3_data
...
FROM [sma_MST_CaseType] CST
	...
	JOIN [TestClientNeedles].[dbo].[user_tab3_matter] M
