...
-- Dynamically get all columns from KurtYoung_Needles..user_tab2_data for unpivoting
...
FROM ( 
    ...
    FROM KurtYoung_Needles..user_tab2_data ud
...
BEGIN
	INSERT INTO [sma_MST_UDFDefinition]
	   ...
	   ,[udfnSortOrder]
		...
		JOIN [KurtYoung_Needles].[dbo].[user_tab2_matter] M
