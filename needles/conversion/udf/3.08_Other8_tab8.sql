...
-- Dynamically get all columns from KurtYoung_Needles..user_tab8_data for unpivoting
...
FROM ( 
    ...
    FROM KurtYoung_Needles..user_tab8_data ud
...
begin
	insert into [sma_MST_UDFDefinition]
		...
		join [KurtYoung_Needles].[dbo].[user_tab8_matter] m
