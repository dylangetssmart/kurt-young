...
-- Dynamically get all columns from KurtYoung_Needles..user_tab7_data for unpivoting
...
FROM ( 
    ...
    FROM KurtYoung_Needles..user_tab7_data ud
...
begin
	insert into [sma_MST_UDFDefinition]
		...
		join [KurtYoung_Needles].[dbo].[user_tab7_matter] m
