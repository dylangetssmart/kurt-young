...
-- Dynamically get all columns from KurtYoung_Needles..user_tab9_data for unpivoting
...
FROM ( 
    ...
    FROM KurtYoung_Needles..user_tab9_data ud
...
BEGIN
	INSERT INTO [sma_MST_UDFDefinition]
	   ...
	   ,[udfnSortOrder]
		...
		JOIN [KurtYoung_Needles].[dbo].[user_tab9_matter] M
