...
from [litify_pm__Intake__c].[litify_pm__Source_Type__c]
*/

--select
--	*
--from shinersa..sma_MST_ReferralType

--select distinct
--	lpic.litify_pm__Source_Type__c
--from ShinerLitify..litify_pm__Intake__c lpic
--where
--	ISNULL(lpic.litify_pm__Source_Type__c, '') <> ''
...
insert into sma_TRN_PdAdvt
	...
	--SELECT * FROM ShinerLitify..litify_pm__Source__c lpsc
