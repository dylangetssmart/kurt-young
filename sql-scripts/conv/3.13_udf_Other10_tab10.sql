...
-- Dynamically get all columns from NeedlesSLF..user_tab10_data for unpivoting
...
FROM ( 
    ...
    FROM NeedlesSLF..user_tab10_data ud
...
select * from NeedlesSLF..user_tab10_data
...
FROM [sma_MST_CaseType] CST
	...
	JOIN [NeedlesSLF].[dbo].[user_tab10_matter] M
