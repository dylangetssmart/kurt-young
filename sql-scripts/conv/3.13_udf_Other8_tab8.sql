...
-- Dynamically get all columns from NeedlesSLF..user_tab8_data for unpivoting
...
FROM ( 
    ...
    FROM NeedlesSLF..user_tab8_data ud
...
select * from NeedlesSLF..user_tab8_data
...
FROM [sma_MST_CaseType] CST
	...
	JOIN [NeedlesSLF].[dbo].[user_tab8_matter] M
