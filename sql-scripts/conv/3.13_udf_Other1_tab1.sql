...
-- Dynamically get all columns from NeedlesSLF..user_tab1_data for unpivoting
...
FROM ( 
    ...
    FROM NeedlesSLF..user_tab1_data ud
...
select * from NeedlesSLF..user_tab1_data
...
FROM [sma_MST_CaseType] CST
	...
	JOIN [NeedlesSLF].[dbo].[user_tab1_matter] M
