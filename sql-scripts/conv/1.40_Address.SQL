...
*/
-- select distinct addr_Type from  [NeedlesSLF].[dbo].[multi_addresses]
-- select * from  [NeedlesSLF].[dbo].[multi_addresses] where addr_type not in ('Home','business', 'other')
...
FROM [NeedlesSLF].[dbo].[multi_addresses] A
